...
# MAGIC %md
# MAGIC 
# MAGIC ## Install some required libraries
# MAGIC 
# MAGIC In this notebook we are generation some fake data containing PII. We will be using some libraries in order to generate our data.
...
# MAGIC %md
# MAGIC 
# MAGIC Defining some widget and variables
...
# MAGIC %md
# MAGIC 
# MAGIC Saving the generated data to a location on the disk in parquet format
